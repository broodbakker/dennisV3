        ...
        <div className="relative pb-16 px-8 mx-auto md:max-w-screen-md">
          ...
          <div className="mb-8 ">
            <p className="text-lg border-b-2 border-gray-200 pb-2 text-fontColor pb-4 mb-4">
              aaVtestia onderstaande links kun je kijken tussen de werkvormen en
...
export async function getStaticProps() {
  const youtubeData = await axios.get(`https://dennis1.netlify.app/.netlify/functions/getYTvideos`)
